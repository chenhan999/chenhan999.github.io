---
layout:     post
title:      2020-04-21-记录一个删除sql备份工具类
subtitle:   2020-04-21-记录一个删除sql备份工具类
date:       2021-01-22
author:     Han
...
//            log.info(patternInsertSQL);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print(Math.ceil(1000 / 100));

        //获取连接参数   &tinyInt1isBit=false   解决tinyint(1) 在java中转为布尔类型  拼装sql时加上单引号 执行sql报错
        String url = "jdbc:mysql://10.158.249.31:3306/cproject?useSSL=false&tinyInt1isBit=false";
        String user = "cproject";
        String password = "dev-cproject";
        Class.forName("com.mysql.jdbc.Driver");
        Connection connection = DriverManager.getConnection(url, user, password);
        Connection connection2 = DriverManager.getConnection(url, user, password);

        String tableName = "m_confirmation_chase";
        String columWhereName = "id";
...
//        values2.add("3");
        ...
        values2.add("35");
        values2.add("34");
        //单行sql操作X条数据 && 单个文件保存X行sql
        InsertSqlUtil insertSqlUtil = new InsertSqlUtil(connection, 15, 4, "C:/data1/share/data/insertSqlBackup/");
//        Boolean aBoolean1 = insertSqlUtil.generateInsertSQL(tableName, columWhereName, values);
        Boolean aBoolean = insertSqlUtil.generateInsertSQL("m_confirmation_chase", "id", values2);

//        System.out.println(aBoolean + "-------" + aBoolean1);

//        String inser = generateInsertStr(connection2, 2, tableName, columWhereName, values);
//        System.out.println(inser);
//        String inser2 = generateInsertStr(connection2, "b_pending_list", "id", values2);
